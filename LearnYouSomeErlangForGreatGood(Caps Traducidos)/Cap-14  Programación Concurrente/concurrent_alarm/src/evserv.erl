...
init() ->
  ...
  %% Debes pasar un argumento a init para indicar donde esta el 
  %% recurso de los eventos. Luego lo cargas desde aca.
  %% Lo otro puediera ser pasar directo los eventos al servidor 
